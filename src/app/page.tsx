...
export default function Home() {
  return (
    <section className='w-full grid grid-cols-12 gap-4 font-space-grotesk'>
      <div className='contact_section h-screen col-span-12 justify-self-stretch px-8 py-8 grid grid-cols-12 gap-4 grid-rows-3'>
        <div className='logo col-span-10 row-start-1'>
        ...
        <div className='primary-title text_content col-span-6 col-start-1 row-span-1 row-start-2 flex items-top'>
          <div>
        ...
        <div className='text_content col-span-6 col-start-7 row-span-1 row-start-2 flex items-end'>
          <div className='contact_details'>
            <p className='email'>email: biuro@rpv.net.pl</p>
            <p className='phone_nr'>tel. +48 515 114 676</p>
            <p className='fb'><a className="btn" href="https://www.facebook.com/RPV.Spzoo">fb</a></p>
            <p className='google'><a className="btn" href="https://maps.app.goo.gl/t1ab2t8aWAiUk6FY8">google</a></p>
          </div>
        </div>
      </div>
    </section>
